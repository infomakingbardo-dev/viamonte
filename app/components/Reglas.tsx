const incluidos = [
  {
    icono: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <circle cx="9" cy="9" r="7.5" stroke="#00422E" strokeWidth="1"/>
        <path d="M6 9l2 2 4-4" stroke="#00422E" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  ...
  },
  {
    icono: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path d="M9 2v7M9 13v3M3 9H2M16 9h-3M5 5L4 4M14 14l-1-1M5 13l-1 1M14 4l-1 1" stroke="#00422E" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
    titulo: "Luz natural",
  ...
  },
  {
    icono: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <rect x="2" y="5" width="14" height="9" rx="1" stroke="#00422E" strokeWidth="1"/>
        <path d="M6 5V4a1 1 0 011-1h4a1 1 0 011 1v1" stroke="#00422E" strokeWidth="1"/>
        <path d="M9 9.5v1M7 9.5h4" stroke="#00422E" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
...
const cancelacion = [
  ...
  { condicion: "Cambio de fecha", estado: "Gratis con 48 hs de aviso", color: "text-[#f0ede8]" },
];
    ...
    <section id="reglas" className="py-28 px-6 border-t border-[#2a2926]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          {/* Incluidos */}
          <div>
            <p className="text-[#f0ede8] text-sm font-medium mb-8 uppercase tracking-widest">Qué está incluido</p>
          ...
          <div className="space-y-10">
            ...
            <div>
              <p className="text-[#f0ede8] text-sm font-medium mb-6 uppercase tracking-widest">Política de cancelación</p>
              <div className="space-y-3">
                {cancelacion.map((c) => (
                  <div key={c.condicion} className="flex items-center justify-between py-3 border-b border-[#2a2926]">
            ...
            {/* Reglas de uso */}
            <div>
              <p className="text-[#f0ede8] text-sm font-medium mb-6 uppercase tracking-widest">Reglas de uso</p>
              <ul className="space-y-3">
                {reglas.map((r) => (
                  <li key={r} className="flex gap-3 text-[#6b6860] text-sm leading-relaxed">
                    <span className="text-[#7F1114] mt-1 shrink-0">—</span>
                    {r}
                  </li>
                ))}
              </ul>
